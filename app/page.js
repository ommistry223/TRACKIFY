      ...
      <main className="container mx-auto px-4 pt-20 pb-16">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex gap-6">
            ...
            <Link href="/login">
              <button className="px-8 py-4 border-2 border-orange-500 text-orange-500 rounded-full font-semibold text-lg hover:bg-orange-50 transform hover:scale-105 transition-all">
                Learn More
              </button>
            </Link>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">Track your expenses with just a few clicks</p>
            </div>
            <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center mb-4 mx-auto">
                <svg className="w-6 h-6 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">Your financial data is always protected</p>
            </div>
          </div>
        </div>
      </main>
